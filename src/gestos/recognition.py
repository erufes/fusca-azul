"""Hand geometry and gesture recognition, independent of the interface."""
...
def identificar_comando(hand):
	...
	extended = [
		distance(hand[0], hand[tip]) > 1.3 * distance(hand[0], hand[base])
	...
	thumb = (
		distance(hand[0], hand[4]) > palm * 1.3
		and outward
